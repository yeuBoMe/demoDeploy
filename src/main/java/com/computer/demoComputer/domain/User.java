...
public class User implements Serializable {
    ...
    @Column(name = "phone_number", columnDefinition = "varchar(255) check (cast(phone_number as integer) >= 10)")
...
// @Size(min = 10, message = "Số điện thoại phải tối thiểu 10 ký tự!") // Sửa
// @Min thành @Size
// @Pattern(regexp = "\\d{10,}", message = "Số điện thoại chỉ được chứa chữ số
// và tối thiểu 10 ký tự!") // Thêm ràng
// // buộc regex
// private String phoneNumber;
...
// fullName=" + fullName
// + ", address=" + address + ", phoneNumber=" + phoneNumber + ", avatar=" +
// avatar + ", role=" + role
// + "]";
// }
// }